...
export class Localizacoes {
  ...
  acessarLocalizacoes(): void {
    ...
    cy.get(SeletoresReutilizaveis.iconeMenu).contains(' Localizações ').click();
  }
  ...
  cadastrarLocalizacaoComTodosCamposPreenchidos(): void {
    ...
    cy.get(SeletoresLocalizacoes.campoEndereco).type(this.endereco_1).wait(500);
  ...
  editarLocalizacao() {
    ...
    cy.get(SeletoresLocalizacoes.campoEndereco).type(this.endereco_2).wait(500);
